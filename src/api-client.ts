...
export class ApiClient {
	...
	async createPlaygroundSnippet(
		...
		return this.call(
			...
			params,
			createPlaygroundSnippetInputSchema,
			createPlaygroundSnippetOutputSchema
		)
	}
	...
	async startPlaygroundSession(
		...
		return this.call(
			...
			params,
			startPlaygroundSessionInputSchema,
			startPlaygroundSessionOutputSchema
		)
	}
	...
	async getRunningPlaygroundSessionDetails(
		...
		return this.call(
			'get-running-playground-session-details',
			params,
			getRunningPlaygroundSessionDetailsInputSchema,
			getRunningPlaygroundSessionDetailsOutputSchema
		)
	}
}
